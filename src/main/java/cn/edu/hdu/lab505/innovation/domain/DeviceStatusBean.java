...
public class DeviceStatusBean {
	...
	public String toString() {
		return "DeviceStatusBean [productId=" + productId + ", productName=" + productName + ", storageLiquid="
				+ storageLiquid + ", storagePressure=" + storagePressure + ", gasifyPressure=" + gasifyPressure
				+ ", gasifyTemperature=" + gasifyTemperature + ", gasFlow1=" + gasFlow1 + ", GPS=" + GPS + ", massFlow="
				+ massFlow + ", carLiquid=" + carLiquid + ", carPressure=" + carPressure + ", ZBOX=" + ZBOX + "]";
	}
